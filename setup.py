...
setup(
    ...
    long_description='This is a Python package that automates your data preprocessing, we will add documentation here on how to use this package. for information visit ofiical repository.',
